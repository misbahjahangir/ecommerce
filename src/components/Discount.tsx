  ...
  return (
    ...
    <section className="flex flex-col items-center justify-center py-12 px-4 lg:flex-row lg:justify-between lg:px-16">
      ...
      <div className="lg:w-1/2 text-center lg:text-left">
        ...
        <h1 className="text-3xl font-bold text-center mb-6 text-blue-900">Discount Item</h1>

        {/* Subheading (Centered Links) */}
        <div className="flex justify-center space-x-4 mt-4">
          <a href="#" className=" text-pink-500">Wood Chair</a>
        ...
        {/* Discount Heading */}
        <h2 className="mt-8 text-2xl font-semibold text-gray-600">20% discount for all products</h2>
        ...
        <br></br>
        <br></br>
        <button className="bg-pink-500 text-white px-20 py-5 text-xl hover:bg-pink-600">Shop Now</button>
      </div>

      {/* Right Image */}
      <div className="mt-10 lg:mt-0 lg:w-1/2 flex justify-center">
           <img src="/discount.svg" alt="Sofa" className="max-w-full h-auto" />
