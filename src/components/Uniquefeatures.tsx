  ...
  return (
    <div className="py-10 px-5 bg-purple-50">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-6">
        <img src="/bluesofa.svg" alt="Sofa" className="w-full md:w-1/2 rounded-lg" />
        <div className="text-center md:text-left">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-blue-900">Unique Features Of Latest & Trending Products</h2>
