...
const LatestProduct = () => {
  // Dummy product data
  const products = [
    { id: 1, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort.png", isSale: false },
    { id: 2, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort2.png", isSale: true },
    { id: 3, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort3.png", isSale: false },
    { id: 4, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort4.png", isSale: false },
    { id: 5, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort5.png", isSale: false },
    { id: 6, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/comfort6.png", isSale: false },
  ];
  ...
  return (
    <section className="py-16 bg-light-gray">
      <div className="container mx-auto px-4">
        {/* Header */}
        <h2 className="text-4xl font-bold text-center text-dark-blue mb-6 text-blue-900">Latest Products</h2>
